...
public interface ConfigModule {
     ...
     */
    void injectAppLifecycles(@NonNull Context context, @NonNull List<AppLifecycles> lifecycles);
     ...
     */
    void injectActivityLifecycles(@NonNull Context context, @NonNull List<Application.ActivityLifecycleCallbacks> lifecycles);
     ...
     */
    void injectFragmentLifecycles(@NonNull Context context, @NonNull List<FragmentManager.FragmentLifecycleCallbacks> lifecycles);
}
